...
Private Sub cmdExcluir_Click()
    If txtIM <> "" Then
        ...
        If Confirma("Deseja cancelar o registro selecionado?", "CIAP") Then
            If cboProcedimento.Coluna(1).Valor = 2 Then
                Avisa "Registro já foi cancelado."
                Exit Sub
            End If
            Do
            ...
            If Bdados.GravaDados("TAB_CONTRIBUINTE_ESTIMADO", Valores, Campos, "TCE_TCI_IM ='" & txtIM & "' and TCE_EXERCICIO = '" & txtDataInicial & "'") Then
                ...
                Valores = Bdados.PreparaValor(Codigo, txtIM, txtDataInicial, Bdados.Converte(txtValor, TCMonetario), _
                            2, Bdados.Converte(Date, TCDataHora), txtProcesso, Bdados.Converte(txtValorMensal, TCMonetario), Bdados.Converte(txtValorAnual, TCMonetario), Bdados.Converte(AplicacoesVTFuncoes.Usuario, tctexto), Bdados.Converte(Motivo, tctexto), Bdados.Converte(txtDataProcesso, TCDataHora))
                
                Bdados.GravaDados "TAB_CONTRIBUINTE_ESTIMADO_HIST", Valores, Campos, "TCE_COD_MUDANCA = '" & Codigo & "'"
                Avisa "Registro cancelado com sucesso."
                cmLimpar_Click
                cmdBuscar_Click
            Else

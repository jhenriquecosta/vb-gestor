...
Private Sub cmdFinaliza_Click()
    ...
    Loop Until Motivo <> ""
    Campos = "TCE_TCI_IM,TCE_EXERCICIO,tce_base_calculo_anual_ufm,TCE_STATUS,TCE_PROCESSO,TCE_VALOR_MENSAL,TCE_BASE_CALCULO_ANUAL,TCE_DATA_PROCESSO"
    Valores = Bdados.PreparaValor(txtIM, txtDataInicial, Bdados.Converte(txtValor, TCMonetario), _
                    1, txtProcesso, Bdados.Converte(txtValorMensal, TCMonetario), Bdados.Converte(txtValorAnual, TCMonetario), Bdados.Converte(txtDataProcesso, TCDataHora))
    If Bdados.GravaDados("TAB_CONTRIBUINTE_ESTIMADO", Valores, Campos, "TCE_TCI_IM ='" & txtIM & "' and TCE_EXERCICIO = '" & txtDataInicial & "'") Then
        'GRAVO O HISTÓRICO...
        Campos = "TCE_COD_MUDANCA,TCE_TCI_IM,TCE_EXERCICIO,tce_base_calculo_anual_ufm,TCE_STATUS,TCE_DATA,TCE_PROCESSO,TCE_VALOR_MENSAL,TCE_BASE_CALCULO_ANUAL,TCE_USUARIO,TCE_MOTIVO,TCE_DATA_PROCESSO"
        Codigo = Conta.GeraCodPagamento(90)
        Valores = Bdados.PreparaValor(Codigo, txtIM, txtDataInicial, Bdados.Converte(txtValor, TCMonetario), _
                    3, Bdados.Converte(Date, TCDataHora), txtProcesso, Bdados.Converte(txtValorMensal, TCMonetario), Bdados.Converte(txtValorAnual, TCMonetario), Bdados.Converte(AplicacoesVTFuncoes.Usuario, tctexto), Bdados.Converte(Motivo, tctexto), Bdados.Converte(txtDataProcesso, TCDataHora))

...
Private Sub CmdGravar_Click()
    ...
    If Confirma("Deseja excluir o registro selecionado?", "CIAP") Then
        If Bdados.DeletaDados("TAB_RESTITUICAO", "TRT_NUMERO = '" & NUMERO & "'") Then

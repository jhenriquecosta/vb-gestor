...
Begin VB.Form TCIS103 
   ...
   Caption         =   "TCIS103 - SAT - Sistema de Administração Tributária"
   ClientHeight    =   8130
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9975
   ControlBox      =   0   'False
   Icon            =   "TCIS103.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin ActiveTabs.SSActiveTabs tabCadastro 
      ...
      Begin ActiveTabs.SSActiveTabPanel SSActiveTabPanel10 
         ...
         _ExtentY        =   11430
         _Version        =   131082
         TabGuid         =   "TCIS103.frx":0AA0
         Begin VB.TextBox txtObservacaoCompleta 
            Height          =   5415
            Left            =   0
            MultiLine       =   -1  'True
            TabIndex        =   77
            Text            =   "TCIS103.frx":0AC8
            Top             =   960
            Width           =   9855
         End
...
Sub PreencheTela(Im As String, Cpf As String)
    ...
    With Contribuinte
        If .Buscar(Im, Cpf, True) Then
            ...
            txtCodAtividade = .CodAtividade
            txtCgc = .CgcCpf
            txtRG = .Rg
            txtcgc_LostFocus
            txtIncriAuxiliar = .ImAuxiliar
            'BCP
            txtIncriAuxiliar = .ImAnterior
            txtObservacaoCompleta = .Obs
            txtAreaEstabelecimento = CDbl(.AreaEstabelecimento)
           ' txtCRC = .Crc
            'BCP
...
Private Sub verificaFantasia()
    If Len(txtFantasia) = 0 Or txtFantasia.Text = "" Then
...
Private Sub cmdSalvar_Click()
    ...
    If Not GraveiContrib Then
        ...
        With Contribuinte
            ...
            .AreaEstabelecimento = CDbl(txtAreaEstabelecimento)
            ...
            .FoneFax = IIf(txtFoneFax = "", 0, txtFoneFax)
            .CNH = txtCnh
            .Categoria = txtCateg
        ...
        If chkCad(2).Value Then
            If Trim(txtCpfRepresentante) <> "" And Trim(txtNomeRepresentante) <> "" Then
                With Representante
                    ...
                    .TipoLogr = cboTipoLogrRepresentante
                    .Logr = cboLogrRepresentante

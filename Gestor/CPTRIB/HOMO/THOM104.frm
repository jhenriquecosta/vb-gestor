...
Private Sub cmdCancelar_Click()
    If grdAutos.ListItems.Count >= 1 Then
        If Confirma("Deseja excluir?", "Ciap - Tributário") Then
            Bdados.AbreTrans
            If Bdados.DeletaDados("tab_auto_infracao", "tai_cod_auto = '" & grdAutos.SelectedItem & "'") Then
            ...
            Else
                Bdados.CancelaTrans
                Avisa "Erro ao excluir Auto de Infração."
            End If
        End If
    End If
End Sub

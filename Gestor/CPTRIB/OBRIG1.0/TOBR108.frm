...
Begin VB.Form TOBR108 
   ...
   Begin Threed.SSFrame fra 
      ...
      Begin VB.ComboBox cboTaxa 
         ...
         ForeColor       =   &H00800000&
         Height          =   300
         ItemData        =   "TOBR108.frx":2123
         Left            =   2775
         List            =   "TOBR108.frx":2125
         Sorted          =   -1  'True
      ...
      Begin VB.ComboBox cboImposto 
         ...
         ForeColor       =   &H00800000&
         Height          =   330
         ItemData        =   "TOBR108.frx":2127
         Left            =   60
         List            =   "TOBR108.frx":2129
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   0
         Tag             =   "Imposto"
      ...
      Begin VB.ComboBox cboConta 
         ...
         ForeColor       =   &H00800000&
         Height          =   330
         ItemData        =   "TOBR108.frx":212B
         Left            =   5940
         List            =   "TOBR108.frx":2138
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Tag             =   "Conta"
      ...
      Begin VB.Frame fraIm 
         ...
         Begin VB.ComboBox cboIC 
            ...
            ForeColor       =   &H00800000&
            Height          =   330
            ItemData        =   "TOBR108.frx":2145
            Left            =   30
            List            =   "TOBR108.frx":2147
            Sorted          =   -1  'True
            TabIndex        =   12
            Top             =   300
            Width           =   1815
...
Private Sub Form_Load()
    ...
    Call Edita.AtualizaCombo(Bdados, cboImposto, "Select  TIP_sigla_IMPOSTO  " & Bdados.Concatena & " ' # ' " & Bdados.Concatena & " tip_nome_imposto From TAB_IMPOSTO " _
        & " WHERE  tip_cod_imposto in (SELECT tpi_tip_cod_imposto FROM Tab_Parametro_Imposto where TPI_GERA_OBRIGACAO = 2 OR TPI_GERA_OBRIGACAO  IS NULL)")
        ...
        If cboConta <> "3" Then
           ...
           If Bdados.AbreTabela(Sql, rs) Then
                  If rs!tpi_tipo_tributo = 2 Then
                      ...
                      txtDtVenc = UltimoDiaDoMes("01/" & txtPeriodo)
                      txtPeriodo.MaxLength = 6
                      Exercicio = txtPeriodo
                      Bdados.FechaTabela rs
                      Exit Sub

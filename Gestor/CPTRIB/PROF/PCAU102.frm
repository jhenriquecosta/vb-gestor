...
Begin VB.Form PCAU102 
   ...
   Begin Cabecalho.cabVISUAL cabVisual 
      ...
      _ExtentX        =   13361
      _ExtentY        =   1138
      Icone           =   "PCAU102.frx":0999
   End
End
Attribute VB_Name = "PCAU102"
...
Private Sub cmdLimpar_Click()
    ...
    Set Acesso = New pAcesso
        Acesso.ExibeSistema treeSistema, tpPrivilegio
    Set Acesso = Nothing
...
Private Sub cmdSalvar_Click()
    ...
    If Pode Then
        ...
        Set Acesso = New pAcesso
            Acesso.GravarAcessoSistema treeSistema, txtCodigo, tpPrivilegio
...
Private Sub txtCodigo_LostFocus()
    ...
    Else
        ...
        Set Acesso = New pAcesso
            Acesso.MarcaAcessos treeSistema, txtCodigo, taSistema, tpPrivilegio

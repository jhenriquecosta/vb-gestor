...
Begin VB.Form TOBR401 
   ...
   Begin Cabecalho.cabVISUAL cabVisual 
      ...
      _ExtentX        =   20479
      _ExtentY        =   1138
      Icone           =   "formObrigConsulta.frx":0000
   End
...
Public Sub MostraObrigacao(numeroDam As String)
  Dim lRes As Boolean
 ' lRes = Obrig.MostraObrigacaoGerada(lstObrig,  "", "", "", 0, "", "", "", "", , "", 0, IIf(Temp.PegaParametro(Bdados, "TRAZER SUBDIVIDA") = "SIM", True, False), numeroDam)
  txtDAM = numeroDam
  cmdBuscar_Click
  cmdImprimir_Click

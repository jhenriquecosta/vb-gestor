...
Begin VB.Form TOBR105 
   ...
   Begin Threed.SSFrame fra 
      ...
      Begin VB.ComboBox cboConta 
         ...
         ForeColor       =   &H00800000&
         Height          =   330
         ItemData        =   "TOBR105.frx":031A
         Left            =   5940
         List            =   "TOBR105.frx":0327
         Sorted          =   -1  'True
      ...
      Begin VB.ComboBox cboTaxa 
         ...
         ForeColor       =   &H00800000&
         Height          =   300
         ItemData        =   "TOBR105.frx":0334
         Left            =   2775
         List            =   "TOBR105.frx":0336
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   9
         Top             =   1680
      ...
      Begin VB.ComboBox cboImposto 
         ...
         ForeColor       =   &H00800000&
         Height          =   330
         ItemData        =   "TOBR105.frx":0338
         Left            =   60
         List            =   "TOBR105.frx":033A
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   0
         Tag             =   "Imposto"
      ...
      Begin VB.Frame fraIm 
         ...
         Begin VB.ComboBox cboIC 
            ...
            ForeColor       =   &H00800000&
            Height          =   330
            ItemData        =   "TOBR105.frx":033C
            Left            =   30
            List            =   "TOBR105.frx":033E
            Sorted          =   -1  'True
            TabIndex        =   11
            Top             =   300
            Width           =   1815

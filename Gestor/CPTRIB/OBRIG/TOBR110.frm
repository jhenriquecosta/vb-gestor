...
Begin VB.Form TOBR110 
   ...
   Caption         =   "TOBR110-Emissão de D.A.M"
   ClientHeight    =   5955
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8910
...
Private Sub cboImposto_LostFocus()
    ...
    txtIm.SetFocus
    If Left(cboImposto.Text, 4) = "IPTU" Then
        txtIm.Enabled = False
...
'    End If
    If Obrig.CriaObrigacao(CStr(cboImposto.coluna(0).Valor), txtPeriodoInicial, _
                ...
                txtVence, , , Grupo, , , , txtOrigem, Nvl(txtParcela, 0), txtImovel, Tipo, IIf(chkRemessa.Value = 1, True, False)) Then

VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} AR_DeclaracoesNotasFiscais 
   Caption         =   "Relatório de Declarações"
   ClientHeight    =   6600
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10245
   Icon            =   "AR_DeclaracoesNotasFiscais.dsx":0000
   StartUpPosition =   3  'Windows Default
   WindowState     =   2  'Maximized
   _ExtentX        =   18071
   _ExtentY        =   11642
   SectionData     =   "AR_DeclaracoesNotasFiscais.dsx":0442
End
Attribute VB_Name = "AR_DeclaracoesNotasFiscais"

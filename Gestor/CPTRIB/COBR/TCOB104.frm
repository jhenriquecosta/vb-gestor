...
Begin VB.Form TCOB104 
   ...
   Begin Threed.SSFrame fra 
      ...
      Begin VB.ComboBox cboTaxa 
         ...
         ForeColor       =   &H00800000&
         Height          =   300
         ItemData        =   "TCOB104.frx":2123
         Left            =   2775
         List            =   "TCOB104.frx":2125
         Sorted          =   -1  'True
      ...
      Begin VB.ComboBox cboImposto 
         ...
         ForeColor       =   &H00800000&
         Height          =   330
         ItemData        =   "TCOB104.frx":2127
         Left            =   60
         List            =   "TCOB104.frx":2129
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   0
         Tag             =   "Imposto"
      ...
      Begin VB.ComboBox cboConta 
         ...
         ForeColor       =   &H00800000&
         Height          =   330
         ItemData        =   "TCOB104.frx":212B
         Left            =   5940
         List            =   "TCOB104.frx":2138
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Tag             =   "Conta"
      ...
      Begin VB.Frame fraIm 
         ...
         Begin VB.ComboBox cboIC 
            ...
            ForeColor       =   &H00800000&
            Height          =   330
            ItemData        =   "TCOB104.frx":2145
            Left            =   30
            List            =   "TCOB104.frx":2147
            Sorted          =   -1  'True
            TabIndex        =   12
            Top             =   300
            Width           =   1815
...
Sub GeraIssqn()
    ...
    If NomeImposto = Imposto.NomeTributo(ttr_ISSQN) Or NomeImposto = Imposto.NomeTributo(ttr_ISSQNCOMP) Or NomeImposto = Imposto.NomeTributo(ttr_ISSQNRET) Or NomeImposto = Imposto.NomeTributo(ttr_ISSQNSUBST) Or NomeImposto = Imposto.NomeTributo(ttr_ISSQNEST) Then
        If cboTipo.Coluna(1).Valor = 1 Then 'DAM BRANCO
            ...
            Obrig.CriaObrigacao Imposto.BuscaCodImposto(NomeImposto), Left(txtPeriodo, 2) & Right(txtPeriodo, 4), Left(txtPeriodo, 2) & Right(txtPeriodo, 4), txtIM, CDbl(txtTotalImposto) - CDbl(Nvl(txtJuros, 0)) - CDbl(Nvl(txtMulta, 0)), etsCreditoNaoLancado, etsCriaNova, txtDtVenc, , , , , , , , 0, , etiContribuinte
        Else
            'DAM Normal
            ...
            Obrig.CriaObrigacao Imposto.BuscaCodImposto(NomeImposto), Right(txtPeriodo, 4) & Left(txtPeriodo, 2), Right(txtPeriodo, 4) & Left(txtPeriodo, 2), txtIM, CDbl(txtTotalImposto) - CDbl(Nvl(txtJuros, 0)) - CDbl(Nvl(txtMulta, 0)), etsCreditoNaoLancado, etsCriaNova, txtDtVenc, , , , , , , , 0
        End If
    End If
'    Call Conta.CriaContaContribuinte(CodPagamento)
'    Call Conta.MovimentaContaContribuinte(CodPagamento)
...
Private Sub Form_Load()
    ...
    Dim i As Byte
    Call Edita.AtualizaCombo(Bdados, cboImposto, "Select TIP_sigla_IMPOSTO   +  ' # '  +  tip_nome_imposto  from tab_imposto where tip_sigla_imposto like 'ISS%'")

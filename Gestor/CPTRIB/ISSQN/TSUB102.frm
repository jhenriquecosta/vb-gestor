...
Private Sub IncluiNotaFiscal()
    ...
    Lista.SubItems(5) = Imposto.NomeTributo(ttr_ISSSUBST)
    Lista.SubItems(6) = txtPeriodo
    Lista.SubItems(7) = txtDtVenc
    Lista.SubItems(8) = txtBase
    Lista.SubItems(9) = CDbl(txtISS)
...
Private Sub cmdSalvar_Click()
    ...
    If Trim(Banco) <> "" Then cboAgente = Banco
    txtImToma_LostFocus
    txtImRem.SetFocus
...
Private Sub Form_Load()
    ...
    '----preencher combos---------------------------------
    Nota.PrencheCboAtividade cboAtividade
...
Private Sub lstPrestador_ColumnClick(ByVal ColumnHeader As MSComctlLib.ColumnHeader)
    OrdenaGrid lstPrestador, ColumnHeader
End Sub
...
Private Sub lstsubstituto_ColumnClick(ByVal ColumnHeader As MSComctlLib.ColumnHeader)
    OrdenaGrid lstsubstituto, ColumnHeader
End Sub

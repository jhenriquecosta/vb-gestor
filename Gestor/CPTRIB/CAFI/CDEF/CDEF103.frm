...
Private Sub cmdBuscar_Click()
    AmbulanteEventual.PreencherGrd grdAmbulante, txtIm
End Sub
...
Private Sub grdAmbulante_ItemCheck(ByVal Item As MSComctlLib.IListItem)
    txtIm = grdAmbulante.SelectedItem.SubItems(12)
    txtIm_LostFocus
End Sub
...
Private Sub cmdCancelar_Click()
    ...
    For i = 1 To grdAmbulante.ListItems.Count
        If (grdAmbulante.ListItems(i).Checked) Then
            With AmbulanteEventual.cadastro
                .icad = grdAmbulante.ListItems(i)
                .Im = txtIm
                .Status = ecCancelado

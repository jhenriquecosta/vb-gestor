...
Private Sub cmdCancelar_Click()
    ...
    For i = 1 To grdSanitario.ListItems.Count
        If (grdSanitario.ListItems(i).Checked) Then
            With Sanitario.cadastro
                .icad = grdSanitario.ListItems(i)
                .Im = txtIm
                .Status = ecCancelado
...
Private Sub grdSanitario_ItemCheck(ByVal Item As MSComctlLib.IListItem)

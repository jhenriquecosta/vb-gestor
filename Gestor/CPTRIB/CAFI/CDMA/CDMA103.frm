...
Private Sub cmdCancelar_Click()
    ...
    For i = 1 To grdMaquina.ListItems.Count
        If (grdMaquina.ListItems(i).Checked) Then
            With MaquinaEquipamento.cadastro
                .icad = grdMaquina.ListItems(i)
                .Im = txtIm
                .Status = ecCancelado
...
Private Sub grdMaquina_ItemCheck(ByVal Item As MSComctlLib.IListItem)

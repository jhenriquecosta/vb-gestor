...
Private Sub cmdBuscarContrib_Click()
    Dim Sql As String
     ...
     If txtIm = "" Then
        Util.Avisa "Informe a Nº Aviso ou a Inscrição."
...
Private Sub cmdEmitir_Click()
    ...
    If grdCPND.ListItems.Count >= 1 Then
        If Confirma("Confirma a entrega da notificação?") Then

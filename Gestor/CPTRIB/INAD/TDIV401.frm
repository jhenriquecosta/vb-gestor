...
Private Sub cmdBuscar_Click()
    ...
    ElseIf txtImovel <> "" Then
        ...
        Insc = txtImovel
    End If
    DAT.CarregaDividaGerada GrdDados, Insc, , txtPeriodoInicial, txtPeriodoFinal, CStr(cboImposto.Coluna(0).Valor), txtDoc, txtFolhaInicial, txtFolhaFinal, txtLivro, Tipo, edTributaria
End Sub
...
'        End If
    ...
    MetodologiaCalculo = Divida.BuscaParametro("METODOLOGIA DE CALCULO", edTributaria)
    
    SelecaoRpt = " {TAB_DIVIDA_ATIVA.TDA_TIPO_DIVIDA} = '1'"
    If txtDoc <> "" Then
    ...
    If CCur(txtValor) > 0 Then
        SelecaoRpt = SelecaoRpt & " and {TAB_DIVIDA_ATIVA.TDA_DIVIDA_TOTAL} >= " & VToA(txtValor)
    End If
    ...
    Select Case cboTipo.Coluna(0).Valor
        Case 1, 2 'MACAL ou MALIC
            With Rpt
                 ...
                 .Selecao = " {VIS_MALIC_MACAL.TPD_CODIGO} = '" & cboTipo.Coluna(0).Valor & "'" & IIf("" & cboImposto.Coluna(0).Valor <> "", " and {VIS_MALIC_MACAL.TPD_ANO} = '" & txtPeriodoInicial & "' and {VIS_MALIC_MACAL.TPD_IMPOSTO} = '" & cboImposto.Coluna(0).Valor & "'", "")
                 .SubRelatorio = ""
                 .Titulo = cboTipo.Text
                 .Arvore = False
                 .Visualizar
        ...
        Case 3, 5 'TERMODAT
            ...
            With Rpt
                ...
                .Formulas "VT_LEI", "DIVIDA ATIVA ART. 11º e 367º, ISSQN ART. 64º ITEM 21.01"
                .Titulo = cboTipo.Text
        ...
        Case 4 ' LIVBRO
            With Rpt
                If Not .DefinirArquivo(Bdados, App.Path + "\TLivroDAT.rpt") Then Exit Sub
                .Selecao = SelecaoRpt
                .Formulas "vt_prefeitura", Temp.PegaParametro(Bdados, "CLIENTE")
                .Formulas "vt_secretaria", Temp.PegaParametro(Bdados, "SEMFAZ")
                .Formulas "VT_MAX_REG", Divida.BuscaParametro("REGISTROS POR FOLHA", edTributaria)
                .Formulas "AUTORIDADE", Autoridade
                .Formulas "CARGO", Cargo
                .Titulo = cboTipo.Text
                .Arvore = False

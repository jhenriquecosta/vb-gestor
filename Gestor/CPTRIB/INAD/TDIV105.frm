...
Private Sub cmdExcluir_Click()
    ...
    condicao = "TDA_REGISTRO = " & txtRegistro & " AND TDA_TOC_COD_OBRIGACAO = " & txtObrigacao & " AND TDA_INSCRICAO = " & txtInscricao & " AND TDA_TIPO_DIVIDA = 1"
    If txtRegistro <> "" Then
...
Private Sub cmdSalvar_Click()
    ...
    campos = " TDA_REGISTRO ,TDA_TOC_COD_OBRIGACAO ,"
    ...
    campos = campos & " TDA_PROCESSO , TDA_TAI_NUM_AUTO,TDA_AUTORIDADE,TDA_CARGO,TDA_TIPO_DIVIDA,TDA_STATUS,TDA_OUTROS"
    
    outros = CDbl((txtDividaOriginal) * (10 / 100))
    Valores = Bdados.PreparaValor(txtRegistro, txtObrigacao, txtEdital, cboNaturezaTributo.Coluna(1).Valor, _
              ...
              txtProcesso, txtNAuto, txtAutoridade, txtCargo, 1, CboStatus.Coluna(1).Valor, outros)
...
Private Sub CarregaDivida()
    ...
    Sql = Sql & " AND tip_cod_imposto = TDA_TIP_COD_IMPOSTO AND TDA_TIPO_DIVIDA = 1"

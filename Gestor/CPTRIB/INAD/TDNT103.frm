...
Private Sub cmdDivida_Click()
    ...
    If Trim(txtIm) <> "" Then
        If DAT.GeraDocumentacao(Nvl(CStr(cboTipo.Coluna(0).Valor), 0), txtPeriodoInicial, txtPeriodoFinal, txtExercicio, txtIm, InscContrib, CStr(cboImposto.Coluna(0).Valor), txtProcesso.Text, , , , LblPercentual, LblRegistros, edNaoTributaria) Then
            DAT.CarregaDividaGerada grdDivida, txtIm, txtExercicio, txtPeriodoInicial, txtPeriodoFinal, CStr(cboImposto.Coluna(0).Valor), , , , , InscContrib, edNaoTributaria
        ...
        End If
    Else
        If DAT.GeraDocumentacao(Nvl(CStr(cboTipo.Coluna(0).Valor), 0), txtPeriodoInicial, txtPeriodoFinal, txtExercicio, txtImovel, InscImovel, CStr(cboImposto.Coluna(0).Valor), txtProcesso.Text, , , , LblPercentual, LblRegistros, edNaoTributaria) Then
...
Private Sub Form_Activate()
    ...
    txtCargo = DAT.BuscaParametro("CARGO AUTORIDADE", edNaoTributaria)
    txtAutoridade = DAT.BuscaParametro("AUTORIDADE COMPETENTE", edNaoTributaria)
End Sub

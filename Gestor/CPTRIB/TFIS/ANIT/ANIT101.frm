...
Dim rs As VSRecordset
    ...
    Sql = "select tae_nome from tab_atividade_economica,tab_contribuinte "
    Sql = Sql & " where tae_cae = tci_tae_cae  and tci_im = '" & txtIm & "'"
    If (txtIm <> "") Then
        If Bdados.AbreTabela(Sql, rs) Then
            txtAtividade = rs!tae_nome
        End If
    End If
End Sub
...
Private Sub cmdSalvar_Click()
    ...
    With Atanit
        .CodPerfilNaoIncidencia = cboPerfil.Coluna(1).VALOR
        ...
        .procedimento.Atributos.TipoProcedimento = tpProcedimentoATA_NIT
...
Private Sub Form_Load()
     ...
     End If
    cboPerfil.Preencher Bdados, "Select * from Tab_Perfil_Constitucional", 1
    cboAutoridade.Preencher Bdados, "select tfu_matricula,tfu_nome from tab_funcionario"
End Sub
